...
%% Frame Dimensions
\newdimen\frameheight \frameheight=48in
\newdimen\framewidth  \framewidth=72in
...
\def\block color#1top#2bottom#3left#4right#5{
	\blockheight=\the\dimexpr#3-#2\relax
	\blockwidth=\the\dimexpr#5-#4\relax
	\vskip#2
	\noindent\hskip#4
	\vbox{\begingroup\color{#1}
		\hrule width\blockwidth height\blockheight depth0pt
	\endgroup}
	\vskip-\blockheight
	\vskip-\blocktop
}

\def\redblock top#1bottom#2left#3right#4      {\block color{red}top#1bottom#2left#3right#4}
\def\greenblock top#1bottom#2left#3right#4    {\block color{green}top#1bottom#2left#3right#4}
\def\blueblock top#1bottom#2left#3right#4     {\block color{blue}top#1bottom#2left#3right#4}
\def\cgemblueblock top#1bottom#2left#3right#4 {\block color{cgemblue}top#1bottom#2left#3right#4}

\def\whiteblock         top#1bottom#2left#3right#4{\block color{white}top#1bottom#2left#3right#4}
\def\verydarkgrayblock  top#1bottom#2left#3right#4{\block color{verydarkgray}top#1bottom#2left#3right#4}
\def\moredarkgrayblock  top#1bottom#2left#3right#4{\block color{moredarkgray}top#1bottom#2left#3right#4}
\def\darkgrayblock      top#1bottom#2left#3right#4{\block color{darkgray}top#1bottom#2left#3right#4}
\def\grayblock          top#1bottom#2left#3right#4{\block color{gray}top#1bottom#2left#3right#4}
\def\lightgrayblock     top#1bottom#2left#3right#4{\block color{lightgray}top#1bottom#2left#3right#4}
\def\verylightgrayblock top#1bottom#2left#3right#4{\block color{verylightgray}top#1bottom#2left#3right#4}
\def\blackblock         top#1bottom#2left#3right#4{\block color{black}top#1bottom#2left#3right#4}
